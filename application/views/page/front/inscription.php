            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="<?php echo base_url('FrontController/inscription_treat'); ?>" class="register-form" id="register-form" method="post">
                            ...
                            <div class="form-group">
                                <label for="name"><i class="bi bi-calendar2-plus"></i></label>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="<?php echo base_url('FrontController/index'); ?>" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
